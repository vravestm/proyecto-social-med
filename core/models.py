...
from datetime import datetime #aca se importa la fecha para los datefield de los modelos
...
class Usuarios(models.Model):
    ...
    edad = models.IntegerField(max_length=3,verbose_name="Edad",null=False)
    zona1 = models.CharField(max_length=20,verbose_name="Comunidad Autonoma",null=False)
    zona2 = models.CharField(max_length=20,verbose_name="Provincia",null=False)
    zona3 = models.CharField(max_length=20,verbose_name="Municipio",null=False)
