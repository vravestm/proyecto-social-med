"""
Django settings for t_social_med project.
...
ROOT_URLCONF = 't_social_med.urls'
...
WSGI_APPLICATION = 't_social_med.wsgi.application'
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'media') #raiz para encontrar los archivos
